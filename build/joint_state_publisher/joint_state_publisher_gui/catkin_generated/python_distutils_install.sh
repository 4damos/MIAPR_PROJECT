...
echo_and_run cd "/home/adam/catkin_ws_projekt/src/joint_state_publisher/joint_state_publisher_gui"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/adam/catkin_ws_projekt/src/joint_state_publisher/joint_state_publisher_gui/setup.py" \
    egg_info --egg-base /home/adam/catkin_ws_projekt/build/joint_state_publisher/joint_state_publisher_gui \
    build --build-base "/home/adam/catkin_ws_projekt/build/joint_state_publisher/joint_state_publisher_gui" \
    install \
    --root="${DESTDIR-/}" \
